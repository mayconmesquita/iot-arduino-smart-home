...
<?php if ($mobile) { ?>
	...
	<?php
		...
		else if ($app == 'ios') 	echo '<link rel="stylesheet" href="assets/css/app/ios.css?v=2">';
		else if ($app == 'desktop') echo '<link rel="stylesheet" href="assets/css/app/desktop.css?v=2">';
		else 						echo '<link rel="stylesheet" href="assets/css/app/android.css?v=2">'; // default to android
	?>
<?php } ?>
		...
		<div class="navbar navbar-default navbar-fixed-top" role="navigation">
			<div class="container">
				<div class="navbar-header pull-left">
					<?php 
						if ($mobile) echo'<a type="button" class="navbar-toggle pull-left" href="#menu">';
				...
				<div id="nav-bar-right" style="height:47px;" class="navbar-header pull-right">
					<ul style="display:inline-flex" class="nav navbar-nav pull-right">
						<?php if ($mobile) { ?><li><a data-extra-action="" data-main-title="<?php echo $_SESSION['title']; ?>" data-page-title="<?php echo $title; ?>" class="refresh-bt btAjaxLoader" style="color:#777;font-size:23px;" href="<?php echo $p; ?>"><i class="fa fa-refresh"></i></a></li><?php } ?>
						<?php if ($mobile) { ?><li>
							...
							<ul id="dropdown-settings" class="dropdown-menu" role="menu">
								...
								<?php if ($perm >= 1)
									echo"<li><a data-main-title=\"{$_SESSION['title']}\" data-page-title=\"{$lang['logout']}\" class=\"link btAjaxLoader\" onclick=\"localStorage.username='';localStorage.password='';localStorage.remember_me='';$('body').delay(50).fadeOut(150);\" href=\"login/sair.php\"><i class=\"fa fa-power-off\"></i>{$lang['logout']}</a></li>"; ?>
							</ul></li>
						<?php } ?>
					</ul>
				</div>
